...
| Hardcover | A free reading tracking social platform. Used primarily to acquire book descriptions and subject/genre tags for books using ISBNs. | Hardcover API, June 11 2026. See file `scripts/data_gathering/get_novel_descriptions.py`.  |  ... |
| Science Fiction Awards Database (SFADB) | Index of science fiction and fantasy awards. Used to acquire list of all finalists for Hugo Award for Best Novel and Locus Awards for Best (Fantasy, Sci-Fi) Novel. | Web scraping using BeautifulSoup, June 11 2026. See files `scripts/data_gathering/get_hugo_nominees.py` and `scripts/data_gathering/get_locus_nominees.py`. |
